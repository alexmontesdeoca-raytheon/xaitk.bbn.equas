...
# train_datadir = "/export/u10/jfaschin_ad/fgvc-aircraft-2013b/pytorch_input_split/train"

# test_datadir = "/export/u10/jfaschin_ad/fgvc-aircraft-2013b/pytorch_input_split/test"

# trainval_datadir = "/export/u10/jfaschin_ad/fgvc-aircraft-2013b/pytorch_input_split/trainval"
...
def evaluate(W, data):
    ...
    Y = np.vstack(Y)
    Y = scipy.special.softmax(Y, axis=1)
    return y_pred, Y
...
def compute_statistics(W_new, gt_label, new_labels, new_classes_features, original_labels, original_features):
    ...
    '''
    y_pred, Y_pred = evaluate(W_new, new_classes_features)
    y_pred_arr  = np.array(y_pred)

    y_pred_original, Y_pred_original = evaluate(W_new, original_features)
